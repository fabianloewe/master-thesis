...
Für die Auswertung der Erkennung von Stego-Tools werden die folgenden drei Metriken verwendet,
...
[cols="1h,2*"]
|===
| | Wirklich Positive | Wirklich Negative

| Zugeordnet Positive
| Wahrpositive / _True positive_ (stem:[tp])
| Falschnegative / _False negative_ (stem:[fn])

| Zugeordnet Negative
| Falschpositive / _False positive_ (stem:[fp])
| Wahrnegative / _True negative_ (stem:[tn])

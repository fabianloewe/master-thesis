...
Um den Einsatz von Information Hiding durch Malware besser widerzuspiegeln, wurde aus den Cover-Bilder des Datensatzes 
zudem Stego-Bilder mit den Verfahren der Strukur-Einbettung erstellt.
...
=== Prototyp zur Merkmalsanalyse steganografischer Bilddaten
